...
while True:
    ...
    if circles is not None:
        ...
        for (x, y, r) in circles:
            # Desenhando uma borda ao redor do circulo e um retangulo
            # em seu centro:
            cv2.circle(output, (x, y), r, (0, 255, 0), 4)

        # Desenhando uma linha entre os dois primeiros circulos, se houver
        # dois circulos:
        if len(circles) == 2:
            ...
            # Colocanto a distancia na tela:
            font = cv2.FONT_HERSHEY_SIMPLEX
            cv2.putText(output, 'Distance : {0:.2f}cm'.format(dist_folha_camera(distancia)), (0,25), font, 1, (255,255,255), 2, cv2.LINE_AA)
